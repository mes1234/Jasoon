using AutoFixture;
using Jasoon.DTO.Poco;
using Newtonsoft.Json;
using Xunit;

namespace ConverterTests;

public class PocoBasedTests
{
    private readonly Fixture _fixture;

    public PocoBasedTests()
    {
    ...
    public void Test_FirstDerivedType()
    {
        ...
        //Act
        var serialized = JsonConvert.SerializeObject(obj);
        var deserialized = JsonConvert.DeserializeObject<ItemWithPreviewDetails>(serialized); 
    ...
    public void Test_SecondDerivedType()
    {
        ...
        //Act
        var serialized = JsonConvert.SerializeObject(obj);
        var deserialized = JsonConvert.DeserializeObject<ItemWithFullDetails>(serialized); 
